...
1.  **Accept the Assignment**
    ...
    - Click **"Accept the assignment"**. This will create your personal assignment repository on GitHub under your organization.
    - You'll be taken to your repository page. Verify that the URL looks like `github.com/ORG/lab-number-yourusername`.

2.  **Clone the Repository to Your Computer**
    - On your repository page, click the green **`<> Code`** button.
    - In the dropdown menu, choose **"Open with GitHub Desktop"**.
    - If GitHub Desktop launches, choose a preferred local folder on your computer to save the project and click **"Clone"**.
    - If GitHub Desktop does **not** launch automatically, stay in the dropdown menu, select the **"Local"** tab, and copy the web URL. Then, open your GitHub Desktop app manually, go to **"File"** > **"Clone repository..."**, select the **"URL"** tab, paste the link, and click **"Clone"**.
...
3.  **Open in VS Code and Start Coding**
    ...
    - VS Code will open the project folder. You can now begin writing your solutions in the `Lab9.java` file.
...
_Same contract, different performances_
